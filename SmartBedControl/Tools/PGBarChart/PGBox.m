...
- (NSString *)makeString {
    ...
    if (_title) {
        ...
        if (_unit) {
            finalText = [_title stringByAppendingString:[[NSString stringWithFormat:@"%d", _value] stringByAppendingString:_unit]];
        }
        else {
            finalText = [_title stringByAppendingString:[NSString stringWithFormat:@"%d", _value]];
        }
    }
    else {
